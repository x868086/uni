...
// let accessLogger = log4js.koaLogger(log4js.getLogger('access'));
...
// let log4js = require('log4js')  //适用express框架的log4js库
/*
 * 第一种：
...
// });
// let loggerFile = log4js.getLogger('log_file');
// let loggerDate = log4js.getLogger('log_date');
...
//app.js中使用 app.use(log4js.connectLogger(log4js.getLogger('access'), { level: log4js.levels.INFO }));
...
//     }
// );
// let loggerFile = log4js.getLogger('file');
// let loggerDate = log4js.getLogger('dateFile');
